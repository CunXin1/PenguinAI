        ...
        {MOCK_TRENDING.map((t) => {
          ...
          return (
            <Link
              ...
              className="flex items-center gap-3 px-2 py-2 rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800/50 transition-colors"
            >
              ...
              <span className="font-mono text-xs text-zinc-600 dark:text-zinc-400 w-16 text-right shrink-0">{money(t.price)}</span>
